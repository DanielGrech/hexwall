...
import com.dgsd.android.hexwall.mvp.view.MvpView;
...
public class TestUtils {
    ...
    public static AppServicesComponent createAppComponent() {
        return createAppComponent(new HWModule((HWApp) RuntimeEnvironment.application));
    }

    /**
     * @see {TestUtils#createAppComponent}
     */
    public static AppServicesComponent createAppComponent(HWModule module) {
