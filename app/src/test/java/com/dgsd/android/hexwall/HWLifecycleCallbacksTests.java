...
public class HWLifecycleCallbacksTests {

    @Test
    public void testIsAppInForegroundWithSingleResumedActivity() {
        final HWLifecycleCallbacks callbacks = createCallbacks();
    ...
    private HWLifecycleCallbacks createCallbacks() {
        return new HWLifecycleCallbacks(){};
    }
