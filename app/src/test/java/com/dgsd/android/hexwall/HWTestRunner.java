...
public class HWTestRunner extends RobolectricGradleTestRunner {
    ...
    public HWTestRunner(Class<?> klass) throws InitializationError {
        super(klass);
    }
        ...
        if (config == null) {
            ...
            return new DelegatingConfig(config) {
                ...
                public String packageName() {
                    ...
                    return HWTestRunner.class.getPackage().getName();
                }
